    ...
    return (
        <View style={styles.content}>
            ...
            <View style={styles.listContainer}>
                <Link style={styles.listItem} href="https://2024.javazone.no/program">2024</Link>
                <Link style={styles.listItem} href="https://2023.javazone.no/#/program">2023</Link>
                <Link style={styles.listItem} href="https://2022.javazone.no/#/program">2022</Link>
                <Link style={styles.listItem} href="https://2019.javazone.no/program">2019</Link>
                <Link style={styles.listItem} href="https://2018.javazone.no/program">2018</Link>
            </View>
        </View>
    );
}
