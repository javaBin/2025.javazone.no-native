...
export const partners: Partner[] = [
  ...
  { name: 'Twoday', homepageUrl: 'https://twoday.no', logoUrl: Twoday },
  { name: 'Techpros', homepageUrl: 'https://www.techpros.no', logoUrl: Techpros },
  { name: 'SSB', homepageUrl: 'https://www.ssb.no', logoUrl: SSB },
  { name: 'SafetyWing', homepageUrl: 'https://safetywing.com', logoUrl: SafetyWing },
  { name: 'Protector', homepageUrl: 'https://www.protectorforsikring.no', logoUrl: Protector },
  { name: 'Novari IKS', homepageUrl: 'https://novari.no', logoUrl: NovariIKS },
