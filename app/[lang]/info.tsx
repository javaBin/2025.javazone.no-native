...
const Info = () => {
  ...
  useEffect(() => {
    // todo: set native style if screen dimensions equals phone
          ...
          <View style={{ display: toggleJavaZone ? 'flex' : 'none' }}>
            ...
            <View style={{ display: 'flex', flexDirection: screenWidth >= 768 ? 'row' : 'column' }}>
              <View style={styles.listItemContainer}>
                ...
                <Link href={Assets.links.javaZoneMail} style={[styles.listItemMail, styles.listItem]}>
            ...
            <View style={{ display: 'flex', flexDirection: screenWidth >= 768 ? 'row' : 'column' }}>
              <View style={styles.listItemContainer}>
                ...
                <Link href={Assets.links.programMail} style={[styles.listItemMail, styles.listItem]}>
                  {t('javaZone.program_mail')}
                </Link>
              </View>
            ...
            <View style={{ display: 'flex', flexDirection: screenWidth >= 768 ? 'row' : 'column' }}>
              <View style={styles.listItemContainer}>
                ...
                <Link href={Assets.links.partnerMail} style={[styles.listItemMail, styles.listItem]}>
            ...
            <View style={{ display: 'flex', flexDirection: screenWidth >= 768 ? 'row' : 'column' }}>
              <View style={styles.listItemContainer}>
                ...
                <Link href={Assets.links.volunteerMail} style={[styles.listItemMail, styles.listItem]}>
                  {t('javaZone.volunteers_mail')}
                </Link>
              </View>
        ...
        <View style={Assets.styles.section}>
          ...
          <View style={{ display: togglePrinciples ? 'flex' : 'none' }}>
            ...
            <Text style={Assets.styles.text}>
              ...
              <Link href={Assets.links.javaBoardMail} style={styles.listItemMail}>
                {t('principles.java_board_mail')}
              </Link>
